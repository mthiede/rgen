ePackage "ECore" do
  eClass "ENamedElement", :abstract => false, :interface => false, :eSuperTypes => ["EModelElement"], :eSubTypes => ["EClassifier", "EEnumLiteral", "EPackage", "ETypedElement"], :instanceClassName => "RGen::ECore::ENamedElement" do
  ...
  eClass "EAnnotation", :abstract => false, :interface => false, :eSuperTypes => ["EModelElement", "EObject"], :instanceClassName => "RGen::ECore::EAnnotation" do
  ...
  eClass "EDataType", :abstract => false, :interface => false, :eSuperTypes => ["EClassifier"], :instanceClassName => "RGen::ECore::EDataType" do
    eAttribute "serializable", :eType => ""
  end
  eClass "EModelElement", :abstract => false, :interface => false, :eSubTypes => ["EFactory"], :instanceClassName => "RGen::ECore::EModelElement" do
  ...
  eClass "ETypedElement", :abstract => false, :interface => false, :eSubTypes => ["EOperation"], :instanceClassName => "RGen::ECore::ETypedElement" do
  ...
  eClass "EObject", :abstract => false, :interface => false, :instanceClassName => "RGen::ECore::EObject"
  ...
  eClass "EStructuralFeature", :abstract => false, :interface => false, :eSuperTypes => ["ETypedElement"], :eSubTypes => ["EAttribute", "EReference"], :instanceClassName => "RGen::ECore::EStructuralFeature" do
